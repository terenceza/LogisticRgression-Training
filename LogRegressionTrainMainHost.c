...
static void LogRegressionTask( void *pvParameters );
/*-----------------------------------------------------------*/
...
static TaskHandle_t xLogRegressionTask;
...
static void vTimerCallback( TimerHandle_t pxTimer )
{
	...
	vTaskDelete( xRxTask );
	vTaskDelete( xTxTask );
    vTaskDelete( xLogRegressionTask);
}
